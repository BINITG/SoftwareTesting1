...
#driver.find_element(By.CLASS_NAME,"login-email").send_keys('naveen30@gmail.com')
...
#driver.find_element(By.XPATH,'//input[@class="form-control private-form__control login-email"]').send_keys('naveen30@gmail.com')
